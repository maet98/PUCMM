...
#include <time.h> //Usada por comando_date
...
int main (int argc, char ** argv) {
  ...
  int finalizar = 0;
  char *prompt = COLOR_AZUL "miniShell> " RESET_COLOR;
...
void mostrar_man(char* comando) {
    if (strcmp(comando,"cd")==0) {
        ...
        printf("Comando 'cat': \n Descripcion: Mostrar contenido de un archivo. \n Uso: cat [nombre_archivo] \n");
    } else if (strcmp(comando,"mv")==0) {
        printf("Comando 'mv': \n Descripcion: Usado para renombre un archivo. \n Uso: mv [nombre_original] [nombre-final] \n");
    } else if (strcmp(comando,"date")==0) {
        printf("Comando 'date': \n Descripcion: Mostrar fecha actual \n Uso: date \n");
    } else  {
